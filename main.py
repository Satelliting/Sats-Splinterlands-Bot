    ...
    while True:
        try:
            ...
            with console.status(
                ...
                player_login_status = page.is_logged_in()
            sleep(randint(1, 3))
            ...
            if not page.is_mid_battle():
                ...
                ecr_wait = 0
                with console.status("[bold white]Calculating Current ECR") as status:
                ...
                if ecr_wait > 0:
                    ...
                    with console.status(
                        "[bold white]Waiting " + str((ecr_wait / 60) / 60) + " Hours",
                        spinner="pong",
                    ) as status:
                        sleep(ecr_wait)
            ...
            battle = Battle(console, player, CARDS_DETAILS, battle_details, BATTLEBASE)
